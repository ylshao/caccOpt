...
%% get fuel consumption fitting handles, and other fcn handles
...
statesInit = [distFollowInit, vVehInit, 0.6]'; % [d, v, SOC]
...
[hamilInit, hamilTrajInit] = ...
    ...
    vVehInit, aVehInit, pBattInit, distFollowInit, fuelConsFcn, distFollowCstr);
...
%     vPre(i) = vPre(i);
    ...
    lambda1(i+1) = lambda1(i) + DT*(LAMBDA4*pdDistFollowCstr(distFollow(i)));
        ...
        case 4
            ...
            if ROOTS_NUM == 1
                ...
                for iRoots = 1:ROOTS_NUM
                    ...
                    stateFour = LAMBDA4*distFollowCstr(distFollow(i+1));
    ...
    vVeh(i+1), aVeh(i+1), pBatt(i+1), distFollow(i+1), fuelConsFcn, distFollowCstr);
