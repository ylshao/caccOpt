function [hamil, hamilTraj] = getHamil(lambda1, lambda2, lambda3, lambda4, vPre, vVeh, aVeh, pBatt, distFollow, fuelConsFcn, distFollowCstr)

V_OC = 201.6; %volt
Q_BATT = 6.5*3600; % ampere*sec
R_BATT = 0.003*6*28;  % ohm
%% get initial Hamiltonian and hamiltonian trajectories
fuelCons = fuelConsFcn(vVeh, aVeh, pBatt);
